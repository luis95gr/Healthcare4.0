...
public class JabraSP extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jabra_sp);
    ...
    private void setupRefreshButton() {
        ...
        btnRefresh.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(JabraSP.this, "Long Press To Scan Devices", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private DeviceConnector.Presenter2 mPresenter = new DeviceConnector.Presenter2() {
        ...
        public void showMessage(String message, boolean loading) {
            JabraSP.this.showLoading(message, loading);
        }
        ...
        public void updateConnectionStatus(boolean connected) {
            ...
            if (connected) {
                ...
                btnUpload.setEnabled(false);
                JabraSP.this.showLoading("Connection lost!", false);
